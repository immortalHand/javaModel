...
package com.shop.modules.sys.redis;


import com.shop.common.utils.RedisKeys;
import com.shop.common.utils.RedisUtils;
...
public class SysConfigRedis {
    ...
    public SysConfigDto get(String configKey){
        String key = RedisKeys.getSysConfigKey(configKey);
        return redisUtils.get(key, SysConfigDto.class);
    }
}
