...
public class SysRoleController extends AbstractController {
	...
	public R select(){
		...
		List<SysRoleDto> list = sysRoleService.selectByMap(map);
	...
	public R save(@RequestBody SysRoleDto role){
		ValidatorUtils.validateEntity(role);
		
		role.setCreatedUser(String.valueOf(getUserId()));
	...
	public R update(@RequestBody SysRoleDto role){
		ValidatorUtils.validateEntity(role);
